const HeroTitleSVG = () => {
  return (
    <svg
      ...
      fill="none"
      aria-hidden="true"
      className="inline-block align-baseline mx-0 translate-y-0.75 scale-[0.9] md:scale-100"
    >
      <path
      ...
      <defs>
        {["a", "b", "c", "d", "e"].map((id) => (
          ...
          >
            ...
            <stop offset="1" stopColor="#03305D" />
          </linearGradient>
        ))}
        ...
        {["a", "b", "c", "d", "e"].map((id) => (
          <linearGradient
            ...
            gradientUnits="userSpaceOnUse"
          >
            <stop stopColor="#6241f2" />
            <stop offset="1" stopColor="#CB52D4" />
          </linearGradient>
        ))}
      </defs>
    </svg>
